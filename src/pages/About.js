      ...
      <Container id="about" className="container-fluid">
        <div className="row">
          <div className="col-sm-8">
            ...
            <br />
            <h4>
              A <b>Decentralised platform</b>using blockchain technology to keep patient medical records organised chronologically
            </h4>
            <br />
            <p>
            When seeing a doctor, there is no need to bring all the paperwork. Your records will be available wherever you go by scanning your public key.
              <br />      Medical history cannot ever be used as evidence, even if it were allowed to do so.
            </p>
            <br />
